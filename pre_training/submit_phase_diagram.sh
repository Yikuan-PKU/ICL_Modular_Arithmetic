...
pl_task_values=(16 32 64 128) # Actual value saved in the end is multiplied by 4 (2 4 8 16 32 64 128)
...
for pl_task in "${pl_task_values[@]}"; do
    ...
    sbatch run_icl_test.sh $port $p $d_embd $depth $n_head $lr $wd $data_pct $pl_task 0 $seed
